...
RegisterPool::RegisterPool() {
    f0 = std::make_shared<RTL_Register_Opd>(std::make_shared<Register>("f0"),
                                            Type::FLOAT);
    v1 = std::make_shared<RTL_Register_Opd>(std::make_shared<Register>("v1"),
                                            Type::INT);
...
std::shared_ptr<RTL_Register_Opd> RegisterPool::getF0() {
    f0->getReg()->setTemp(nullptr);
    return f0;
}

std::shared_ptr<RTL_Register_Opd> RegisterPool::getV1() {
