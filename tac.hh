...
class TAC_Opd {
  ...
  public:
    ...
    virtual std::shared_ptr<RTL_Code> build_rtl(std::shared_ptr<ProcSymbolTable>) = 0;
...
class Binary_TAC_Opd : public TAC_Expr {
  ...
  public:
    ...
    std::shared_ptr<RTL_Code> build_rtl(std::shared_ptr<ProcSymbolTable>) override;
};
...
class Variable_TAC_Opd : public TAC_LOpd, public Printable_Opd {
  ...
  public:
    ...
    virtual std::shared_ptr<RTL_Code> build_rtl(std::shared_ptr<ProcSymbolTable>) override;
};
