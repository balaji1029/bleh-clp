...
sclp: main.o compiler.o y.tab.o lex.yy.o ast.o symtab.o utils.o tac.o tac_print.o rtl.o rtl_print.o register.o asm.o
	$(CXX) $(CXXFLAGS) $^ -o $@
...
asm.o: asm.cc asm.hh rtl.hh register.hh symtab.hh
	$(CXX) $(CXXFLAGS) -c $< -o $@
